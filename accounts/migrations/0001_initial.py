    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identity_source', models.CharField(choices=[('LOCAL', 'Local'), ('AZURE', 'Azure'), ('GOOGLE', 'Google')], default='LOCAL', max_length=20)),
                ('azure_oid', models.CharField(blank=True, max_length=64, null=True)),
                ...
                ('email_domain', models.CharField(blank=True, max_length=128, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('relation', models.CharField(default='parent', max_length=32)),
